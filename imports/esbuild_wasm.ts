...
export type EsbuildResult = TransformResult | TransformFailure & { code?: string }

export async function transform(input: string, options?: TransformOptions): Promise<EsbuildResult> {
    if (!___READY)
